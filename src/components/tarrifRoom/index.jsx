  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={sliderWrapperStyle}>
        ...
        {/* Current Slides - Two Cards Horizontally */}
        <div style={{ 
          display: 'flex', 
          flexDirection: isMobile ? 'column' : 'row', 
          ...
          {getCurrentRooms().map((room, idx) => (
            <div key={`${room.id}-${idx}`} style={{ borderRadius: '8px', overflow: 'hidden', flex: isMobile ? 'none' : '1' }}>
              <div style={cardContainerStyle}>
                {/* Image Section */}
                <div style={imageContainerStyle}>
                  <img
                  ...
                  />
                  <div style={badgeStyle}>
                    ( Only {room.roomsLeft} Room(s) left)
                  </div>
                </div>
                ...
                <div style={contentStyle}>
                  <div>
                    ...
                    <div style={metaContainerStyle}>
                      ...
                      <div style={metaItemStyle}>
                        <Baby size={isMobile ? 16 : 18} color="#888" />
                        <span>Max Child - {room.maxChildren}</span>
                      </div>
                    </div>
